#!/usr/bin/env bash
# ────────────────────────────────────────────────────────────────
#  Setup-16GB (Bazzite) – NexGen3D v1.5
#
...
systemctl disable oberon‑governor 2>/dev/null || true &&
...
sudo btrfs filesystem mkswapfile --size 16G /var/swap/swapfile 2>/dev/null || true &&
